# CRUDY
This is a crud application built with sencha version 6.5 (frontend) and codeigniter version 3 (backend). 
The application should reside in the htdocs folder of xampp directory.
...
process.
 ...
 - `"build"` - This folder contains the output of the build. The generated CSS file,
...
## Backend
Contains all codeigniter files to run the application.

#### backend/application/
It’s where all code specific to our app lives, including all of its models, controllers, and views.
...
This area is intended for overrides like these:
    ...
    Ext.define('CRUDY.overrides.foo.Bar', {
